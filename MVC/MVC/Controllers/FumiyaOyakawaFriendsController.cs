...
namespace MVC.Controllers
{
    public class FumiyaOyakawaFriendsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FriendId,Nombre,Friend,Birthdate")] FumiyaOyakawaFriend fumiyaOyakawaFriend)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FriendId,Nombre,Friend,Birthdate")] FumiyaOyakawaFriend fumiyaOyakawaFriend)
        {
            if (ModelState.IsValid)
            {
